...
#include "Http.h"
#include "CONTROLLER_BASE.generated.h"
 ...
 */
UCLASS()
class GIANTS_API ACONTROLLER_BASE : public APlayerController
{
	GENERATED_BODY()
